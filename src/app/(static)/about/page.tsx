...
const blurPlaceholderURI =
  'data:image/png;base64,';
      ...
      <div className='flex flex-col md:flex-row-reverse gap-6 md:gap-4 lg:gap-6 xl:gap-8'>
        <div className='image-column flex-1'>
          <Image
            ...
            placeholder='blur'
            preload={true}
            blurDataURL={blurPlaceholderURI}
            src={profile}
