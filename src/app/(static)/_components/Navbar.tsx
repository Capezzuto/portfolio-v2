		...
		<nav className={`Navbar group h-full`}>
			...
			<div className='Navbar-mobile group block md:hidden relative'>
				...
				<div
					...
					className={`${showMenu ? 'opacity-100 pointer-events-auto' : 'opacity-0 translate-x-1/6 pointer-events-none'} absolute mt-1 right-0 px-0 py-0 backdrop-blur-md rounded-lg border border-neutral-500 border-b-2 transition transition-property-(--mobile-transition) ease-out duration-(--mobile-duration) delay-(--mobile-delay)`}
				>
					<MenuOptions />
				</div>
			</div>
